...
class FarmerData {
 ...
 var Farmer_Rating = arrayOf("3/5", "4/5", "2.4/5", "4/5", "5/5")

 var Farmer_Dist = arrayOf("3km", "4km", "10km", "50km", "3km")

 var Farmer = arrayOf("1", "2", "3", "4", "5")
 ...
 fun GenerateList(size: Int): List<FarmerListing> {
  ...
  for (i in 0 until size) {
   ...
   if (i == 0) {
    val item = FarmerListing(drawable, Farmer_Name[i], Farmer_Desc[i], Farmer_Rating[i], Farmer_Dist[i])
    list += item
